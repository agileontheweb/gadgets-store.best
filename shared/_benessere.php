      ...
      <div class="bg-black text-white rounded-lg shadow-xl">
        <div class="p-12">
          ...
          <div class="mt-8 text-center">
            ...
            <a href="prodotti-benessere.php" class="block mt-6 text-black bg-white hover:bg-black border-4 hover:border-4 hover:border-red-400 hover:text-white rounded-full px-12 py-3 shadow-xl focus:outline-none">
              Vai
            </a>
          </div>
        </div>
