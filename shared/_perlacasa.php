<div class="bg-gray-200">
        ...
        <div class="p-12">
          <a href="<?php echo $value ?>" <?php if($target == true){?> target="_blank" rel="nofollow" <?php }?>>
            ...
            <div class="mt-8 text-center">
              ...
              <p class="block mt-6 bg-gray-500 hover:bg-gray-400 text-white rounded-full px-12 py-3 shadow-xl focus:outline-none">
                Vedi
              </p>
            </div>
          </a>
  ...
  <div class="text-center py-12">
    <a href="prodotti-casa.php" class="inline-block border-2  p-3 rounded text-gray-500 border-gray-500 hover:bg-gray-500 hover:text-white">
      Vedi tutti
    </a>
  </div>
</div>
